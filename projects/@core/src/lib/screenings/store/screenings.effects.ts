...
import { CinemasApiService } from '@ultraplex-app/api';
import { catchError, map, switchMap } from 'rxjs/operators';
import { CreateScreening, CreateScreeningFail, CreateScreeningSuccess, EScreeningsActions, LoadScreenings } from './screenings.actions';
...
export class ScreeningsEffects {
  ...
  //     switchMap((action) => this.api.getCinemaScreenings(action.payload)),
