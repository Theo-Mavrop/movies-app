...
import { BaseCreateRequest, BaseRequest, CinemaDTO } from '@movies-app/api';
import { CreateCinema, getCinemasError, getCreateError, ICinemasState, isCreated, LoadCinemas, selectCinemas, selectCinemasTotal } from '@movies-app/core';
