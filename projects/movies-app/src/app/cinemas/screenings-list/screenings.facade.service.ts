...
import { CreateBooking, getCreateBookingError, getScreeningsError, isBookingCreated, IScreeningsState, LoadScreenings, selectScreenings, selectScreeningsTotal } from '@movies-app/core';
