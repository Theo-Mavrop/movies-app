...
import { IDashboardState, LoadTotalBookings, LoadTotalCinemas, LoadTotalMovies, selectTotalBookings, selectTotalCinemas, selectTotalMovies, selectTotalScreens } from '@ultraplex-app/core';
